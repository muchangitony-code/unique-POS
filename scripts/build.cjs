...
const requiredFiles = [
  ...
  'server/pdf/index.cjs', 'server/pdf/stable.cjs', 'server/pdf/schema.cjs', 'server/pdf/format.js', 'server/pdf/fonts.cjs', 'server/pdf/bundle-loader.cjs', 'server/pdf/legacy-adapter.cjs',
  ...
  'scripts/bootstrap-db.cjs', 'scripts/database-url.cjs', 'scripts/run-migrations.cjs', 'scripts/schema-config.cjs', 'scripts/sql-utils.cjs', 'scripts/validate-startup-env.cjs', 'scripts/user-management-server.cjs', 'scripts/patch-pdf-renderer.cjs',
...
console.log('[build] Stable PDF renderer installed for invoices/quotations; shared branding engine preserved; user-management routes patched; document deletion routes patched; M-Pesa routes patched; deterministic runtime bundle generated at index.runtime.cjs');
