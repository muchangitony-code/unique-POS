...
const { registerBulkImportV2Routes } = require('./bulk-import-v2-router.cjs');
...
function mountInventoryV3(app) {
  ...
  registerBulkImportV2Routes({app,pool:db(),requireAuth:typeof globalThis.requireAuth==='function'?globalThis.requireAuth:undefined});
